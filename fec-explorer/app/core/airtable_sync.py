...
FIELD_MAPPING = {
    ...
    "frais_telecom":              "frais_telecom",
    "achats_non_stockes":         "achats_non_stockes",
    ...
    "compte_exploitant":          "compte_exploitant",
...
def create_missing_fields() -> None:
    ...
    fields_to_create = [
        ...
        "liquidite_generale", "delai_client", "ratio_endettement",
